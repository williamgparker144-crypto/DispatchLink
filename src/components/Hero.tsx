...
const Hero: React.FC<HeroProps> = ({ onGetStarted, onLearnMore }) => {
  return (
    <section className="relative bg-gradient-to-br from-[#1E3A5F] via-[#1E3A5F] to-[#1E3A5F] overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white">
            <div className="inline-flex items-center gap-2 bg-[#3B82F6]/20 px-4 py-2 rounded-full mb-6">
          ...
          <div className="glass-card rounded-2xl shadow-2xl p-6 lg:p-8">
            ...
            <div className="space-y-4">
              ...
              <button
                onClick={onGetStarted}
                className="w-full py-4 bg-[#1E3A5F] text-white rounded-xl font-semibold hover:bg-[#1E3A5F]/80 transition-colors flex items-center justify-center gap-2"
              >
